...
//_____________________________________________________clients______________________________________________________________
    ...
    private  void fill_combo_clients(){
        ...
        String sql = "SELECT * FROM clientstable WHERE s = '1' AND clientid != '1'";
        String value = "name";
    ...
    public void loadPayments(){
        ...
        String sql = "SELECT id,payment_date AS 'Payment Date',details AS 'Details',debit AS 'Paid Amount' FROM paymentstable WHERE s = '1' AND client_id = '"+clientid+"'"
                + "AND debit > 0 AND payment_date BETWEEN '"+((JTextField)chooserFrom.getDateEditor().getUiComponent()).getText()+"' AND"
    ...
    private void load_generalreport(){
        ...
        String sql = "SELECT paymentstable.id AS 'id',paymentstable.payment_date AS 'Date',clientstable.name AS 'Client Name',clientstable.email AS "
                ...
                + "paymentstable.client_id AND paymentstable.s = '1' AND paymentstable.payment_date BETWEEN '"+from+"' AND '"+to+"'";
        manage.update_table(sql, tableGeneralReports);
        
        try{
            String query = "SELECT COALESCE(SUM(credit),0),COALESCE(SUM(debit),0),COALESCE(SUM(expenses_amount),0) FROM paymentstable WHERE s = '1' AND payment_date "
                    + "BETWEEN '"+from+"' AND '"+to+"'";
            pst = conn.prepareStatement(query);
            rs = pst.executeQuery();
                if(rs.next()){
    ...
    public ArrayList<SearchInvoice> ListInvoice(String ValToSearch){
        ...
        try{
            String searchQuery = "SELECT * FROM invoicetable,clientstable,userstable WHERE invoicetable.user_id = userstable.id AND invoicetable.client_id "
                    ...
                    + " AND invoicetable.s = '1' AND invoicetable.invoice_date BETWEEN '"+from+"' AND '"+to+"'";
...
//   ____________________________________________________________________________________________________________________________________________________--expense--------
    public void loadExpenses(){
        ...
        String sql = "SELECT expense_id AS 'id',expense_name AS 'Expense',mop AS 'Payment Means',transactionNo AS 'Transaction#',amount AS 'Amount' "
                + "FROM expensestable WHERE s = '1' AND expense_date BETWEEN '"+from+"' AND '"+to+"'";
    ...
    public void totalexpenses(){
        ...
        String to = ((JTextField)chooserTo.getDateEditor().getUiComponent()).getText();
        try{
            String sql = "SELECT COALESCE(SUM(amount),0) FROM expensestable WHERE s = '1' AND expense_date BETWEEN '"+from+"' AND '"+to+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
                if(rs.next()){
    ...
    private void initComponents() {
        ...
        buttonPrintclients.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/print.png"))); // NOI18N
        ...
        buttonPrintPayment.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/print.png"))); // NOI18N
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/search.png"))); // NOI18N
        ...
        buttonDeleteQuotation.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/trash.png"))); // NOI18N
        ...
        buttonPrintQuote.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/print.png"))); // NOI18N
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/search.png"))); // NOI18N
        ...
        buttonDeleteInvoice.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/trash.png"))); // NOI18N
        ...
        buttonPrintInvoice.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/print.png"))); // NOI18N
        ...
        buttonPrintGeneral.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/print.png"))); // NOI18N
       ...
       try{
            ...
            rs = pst.executeQuery();
                if(rs.next()){
                    ...
                    lbl_client.setText(rs.getString("email"));
                     loadPayments();
               ...
               int countrows = tablePayments.getRowCount();
                if(countrows < 1){
                    ...
                    String sql = "SELECT companytable.company_name,companytable.location,companytable.address,companytable.city,companytable.phone_no,"
                            ...
                            + "paymentstable,clientstable WHERE userstable.company_id = companytable.id AND userstable.id = paymentstable.user_id AND "
                            + "paymentstable.client_id = clientstable.clientid AND paymentstable.client_id = '"+clientid+"' AND paymentstable.payment_date BETWEEN "
                            + "'"+from+"' AND '"+to+"' AND paymentstable.s = '1'";
                    String path = "Reports/payments.jrxml";
                    String title = "Client's Individual Report";
                    manage.report(sql, path, jPanel9);
                }
           ...
           protected Void doInBackground() throws Exception {
               ...
               int countrows = tableGeneralReports.getRowCount();
                if(countrows < 1){
                    ...
                    Manage manage = new Manage();
                    String sql = "SELECT companytable.company_name,companytable.location AS 'company_location',companytable.address AS 'company_address',"
                            + "companytable.city AS 'company_city',companytable.phone_no AS 'company_phone',companytable.email AS 'companytable.email', "
                            + "paymentstable.id AS 'id',paymentstable.payment_date AS 'Date',clientstable.name AS 'Client Name',clientstable.email AS "
                            + "'Email Address',paymentstable.details AS 'Details',paymentstable.debit AS 'Debit',paymentstable.credit AS 'Credit',"
                            + "paymentstable.expenses_amount AS 'Our Expenses',userstable.name AS 'served_by' FROM userstable,clientstable,paymentstable,"
                            + "companytable WHERE paymentstable.user_id = userstable.id AND clientstable.clientid = paymentstable.client_id AND userstable.company_id"
                            + " = companytable.id AND paymentstable.s = '1' AND paymentstable.payment_date BETWEEN '"+from+"' AND '"+to+"'";
    ...
    private void buttonPrintInvoiceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPrintInvoiceActionPerformed
        ...
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>(){
            ...
            protected Void doInBackground() throws Exception {
                ...
                Manage manage = new Manage();
                String sql = "SELECT companytable.company_name,companytable.location,companytable.address,companytable.city,companytable.phone_no,"
                + "companytable.email,companytable.pin,clientstable.name,clientstable.address AS 'client_address',clientstable.city AS "
                + "'client_city',clientstable.phone_no AS 'client_phone',clientstable.email AS 'client_email',invoicetable.invoice_no,invoicetable."
                + "total,userstable.name AS 'servedby',clientstable.balance FROM companytable,userstable,clientstable,invoicetable WHERE userstable.company_id"
                        + " = companytable.id AND invoicetable.user_id = userstable.id AND clientstable.clientid = invoicetable.client_id AND invoicetable.s = '1' AND "
                + "invoicetable.invoice_no = '"+invoiceno+"'";
    ...
    public ArrayList<SearchQuotation> ListQuotation(String ValToSearch){
        ...
        try{
            String searchQuery = "SELECT * FROM quotation_table,userstable WHERE quotation_table.user_id = userstable.id AND CONCAT(quotation_table.quotation_no,'',"
                    ...
                    + "quotation_table.quotation_date,'',userstable.name) LIKE'%"+ValToSearch+"%' AND quotation_table.s = '1' AND quotation_table.quotation_date "
                    + "BETWEEN '"+from+"' AND '"+to+"'";
            pst = conn.prepareStatement(searchQuery);
            rs = pst.executeQuery();
    ...
    private void buttonPrintQuoteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPrintQuoteActionPerformed
        SwingWorker<Void, Void> worker = new SwingWorker<Void, Void>(){
            ...
            protected Void doInBackground() throws Exception {
                ...
                Manage manage = new Manage();
                String sql = "SELECT companytable.company_name,companytable.location,companytable.address,companytable.city,companytable.phone_no,"
                        + "companytable.email,companytable.pin,quotation_table.client_name,quotation_table.address AS 'client_address',quotation_table.city "
                        + "AS 'client_city',quotation_table.phone_no AS 'client_phone',quotation_table.email AS 'client_email',quotation_table.quotation_no,"
                        + "quotation_table.total,userstable.name AS 'servedby' FROM companytable,userstable,quotation_table WHERE userstable.company_id = "
                        + "companytable.id AND quotation_table.user_id = userstable.id AND quotation_table.s = '1' AND quotation_no = '"+quotationno+"'";
