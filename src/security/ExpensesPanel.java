...
public class ExpensesPanel extends javax.swing.JPanel {
    ...
    public void showdialogexpenses(){
        DialogExpenses.setVisible(true);
        DialogExpenses.setSize(830, 310);
        DialogExpenses.setAlwaysOnTop(true);
        DialogExpenses.setLocationRelativeTo(this);
        DialogExpenses.setResizable(false);
    ...
    private void save_to_payment(){
        try{
            ...
            JOptionPane.showMessageDialog(null, e+" save_to_payment");
        }finally{
            try{
                rs.close();
                pst.close();
    ...
    private void selectedrow(){
        try{
            ...
            String sql = "SELECT * FROM expensestable WHERE s = '1' AND expense_id = '"+table_click+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
                if(rs.next()){
                    ...
                    txtExpenseName.setText(expensename);
                        if(expensename.equals("TOTAL SALARIES")){
                            JOptionPane.showMessageDialog(null, "Cannot Edit this record here. Please Go to the payroll tab");
                        }else{
                    showdialogexpenses();
    ...
    private void update(){
        ...
        String sql = "UPDATE expensestable SET expense_date = '"+((JTextField)ChooserDate.getDateEditor().getUiComponent()).getText()+"',"
                ...
                + "'"+txtTransactionNo.getText()+"' WHERE expense_id = '"+expenseid+"' AND s = '1'";
        manage.update(sql);
        String query = "UPDATE paymentstable SET payment_date = '"+((JTextField)ChooserDate.getDateEditor().getUiComponent()).getText()+"',"
                + " expenses_amount = '"+txtAmount.getText()+"' WHERE details = '"+expenseid+"' AND s = '1'";
        manage.update(query);
        String name = "Expense "+txtExpenseName.getText()+"";
        manage.loggedmessageupdate(name);
        
        lbl_exception.setText("Expense Updated Successfully...");
        reset();
        
    }
    private void delete(){
        Manage manage = new Manage();
        String sql = "UPDATE expensestable SET s = '0' WHERE expense_id = '"+expenseid+"' AND s = '1'";
        manage.update(sql);
        String query = "UPDATE paymentstable SET s = '0'WHERE details = '"+expenseid+"' AND s = '1'";
        manage.update(query);
        String name = "Expense "+txtExpenseName.getText()+"";
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtExpenseName, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(comboPaymentMeans, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/security/icons/expenses.png"))); // NOI18N
