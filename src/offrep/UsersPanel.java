...
public class UsersPanel extends javax.swing.JPanel {
    ...
    private void save(){
        try{
            ...
            String hashed = BCrypt.hashpw(confirm, BCrypt.gensalt());
    ...
    private void update(){
        ...
        if(txtIdNumber.getText().equals("")){
                ...
                String sql = "UPDATE userstable SET id_number = '"+txtIdNumber.getText()+"',name = '"+txtName.getText()+"',phone_no = '"+txtPhoneNo.getText()+"',"
                        + "user_type = '"+comboUsertype.getSelectedItem().toString()+"',username = '"+txtUsername.getText()+"',password = '"+hashed+"'"
                        + "WHERE id = '"+userid+"'";
                manage.update(sql);
                lbl_exception.setText("User "+txtName.getText()+" Updated Successfully...");
                loadtable();
                reset();
            }
    }
    ...
    private void initComponents() {
        ...
        comboUsertype.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Usertype", "Admin", "User" }));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/offrep/icons/users.png"))); // NOI18N
